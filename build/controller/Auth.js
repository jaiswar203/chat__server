...
var AuthController = /** @class */ (function () {
    ...
    AuthController.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, name, isUserExist, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        user = new User_1.default({ email: email, password: password, name: name });
                        return [4 /*yield*/, user.save()];
                    case 2:
                        _b.sent();
                        res.status(201).json((0, Packet_1.Packet)("User Created Succesfully", user));
                        return [2 /*return*/];
                }
            });
        });
    ...
    __decorate([
        (0, decorator_1.post)("/"),
        (0, decorator_1.use)(logger),
        (0, decorator_1.bodyValidator)("email", "password", "name"),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object]),
